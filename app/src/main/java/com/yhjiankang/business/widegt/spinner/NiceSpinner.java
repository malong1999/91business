package com.yhjiankang.business.widegt.spinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int topPadding = resources.getDimensionPixelSize(R.dimen.spinner_margin);
        setGravity(Gravity.CENTER_VERTICAL | Gravity.CENTER);
        setPadding(topPadding, topPadding, topPadding,
                topPadding);
        setClickable(true);
    ...
    public void setAdapter(@NonNull ListAdapter adapter) {
        this.adapter = new NiceSpinnerAdapterWrapper(getContext(), adapter, getResources().getColor(R.color.black), backgroundSelector);
