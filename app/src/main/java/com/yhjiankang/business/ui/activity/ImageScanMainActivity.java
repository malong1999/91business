...
import com.yhjiankang.business.widegt.imagescan.GroupAdapter;
import com.yhjiankang.business.widegt.imagescan.ImageBean;
...
public class ImageScanMainActivity extends BaseActivity {
            ...
            switch (msg.what) {
                ...
                case SCAN_OK:
                    ...
                    if (mGruopMap.size() > 0) {
                        ...
                        Toast.makeText(ImageScanMainActivity.this, "没有找到任何图片", Toast.LENGTH_LONG).show();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allSelectMap = (HashMap<String, String>) getIntent().getSerializableExtra("imgs");
        ...
        btnOk.setText(String.format("完成(%s/%s)", allSelectMap.size(), Constants.ADDGOODSIMAGE_COUNT));
        ...
        mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mIntent.putExtra("allselect", allSelectMap);

                mIntent.putExtra("tag", String.valueOf(position));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1) {
            ...
            allSelectMap = (HashMap<String, String>) data.getSerializableExtra("allselect");
