...
import com.yhjiankang.business.chat.utils.BitmapDecoder;
import com.yhjiankang.business.chat.utils.ScreenUtil;
import com.yhjiankang.business.chat.view.CheckedImageButton;
...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    public static final String TAG="EmoticonPickerView";
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.view_emoji_layout, this);
    }
    ...
    public void setListener(IEmoticonSelectedListener listener) {
        if (listener != null) {
            ...
            Log.i(TAG, "setListener: sticker______listener is null");
        }
    }
    ...
    private void show() {
        if (listener == null) {
            Log.i(TAG, "show: sticker__show picker view when listener is null");
        }
        if (!withSticker) {
            showEmojiView();
        } else {
